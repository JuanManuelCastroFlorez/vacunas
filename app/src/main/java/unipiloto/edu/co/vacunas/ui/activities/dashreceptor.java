...
public class dashreceptor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashreceptor);
        intiComponents();
    }
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    dashreceptor.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    public void inventario(View view) {
        Intent intent=new Intent(view.getContext(),inventarionacActivity.class);
        startActivity(intent);
    }
    public void asgv(View view) {
        Intent intent=new Intent(view.getContext(),asigvacActivity.class);
        startActivity(intent);
    }
    public void remitir(View view) {
        Intent intent=new Intent(view.getContext(),remitirActivity.class);
        startActivity(intent);
    }
    public void distribucion (View view) {
        Intent intent=new Intent(view.getContext(),distribucionActivity.class);
        startActivity(intent);
    }
